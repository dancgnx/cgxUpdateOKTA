...
def go():
    ...
    custom_group = parser.add_argument_group('custom_args', 'Update prefix list')
    custom_group.add_argument("--prefix", help="Prefix-list to update",required=True,
                              default=None, action="store")
    custom_group.add_argument("--url", help="URL to load the OKTA prefix list from",required=True,
                              default=None, action="store")
